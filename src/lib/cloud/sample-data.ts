...
function createSampleAWSVM(id: string, name: string, securityPosture: 'critical' | 'high' | 'medium' | 'low' | 'secure'): VMInstance {
  ...
  // Configure based on security posture
...
export const sampleVMs: VMInstance[] = [
  createSampleAWSVM('0abc123def456', 'prod-web-server-01', 'critical'),
  createSampleAWSVM('1def234abc567', 'prod-app-server-01', 'high'),
  createSampleAWSVM('2ghi345def678', 'prod-db-server-01', 'medium'),
  createSampleAWSVM('3jkl456ghi789', 'prod-cache-server-01', 'low'),
  createSampleAWSVM('4mno567jkl890', 'prod-secure-api-01', 'secure'),
  createSampleAWSVM('5pqr678mno901', 'dev-web-server-01', 'critical'),
  createSampleAWSVM('6stu789pqr012', 'staging-app-01', 'high'),
  createSampleAWSVM('7vwx890stu123', 'prod-worker-01', 'medium'),
];
...
export function generateRandomVMs(count: number, provider: CloudProvider = 'aws'): VMInstance[] {
